...
├── config.py                # Hyperparameters, paths, and environment setup
├── utils.py                 # Helper functions (preprocessing, file checking)
├── dataset.py               # Data loading, DataFrame processing, and one-hot encoding
